...
<main>
    ...
    <div class="available-rewards">
        ...
        <div class="reward-card">
            <img src="<?php echo $rewardData['rewardPic'];?>" alt="Reward Picture">
            <p>Reward Name: <?php echo isset ($rewardData['rewardName']) ? $rewardData['rewardName'] :''?></p>
            <p>Points Needed: <?php echo isset ($rewardData['pointsNeeded']) ? $rewardData['pointsNeeded']:''?></p>
            <form method="post" enctype="multipart/form-data" action="">
                <input type="hidden" name="rewardID" value="<?php echo $rewardData['rewardID'];?>">
